...
export const ErrorView = (props: ParentProps<{ title?: string; subtitle?: string }>) => {
  return (
...
export const LoadingView = (props: ParentProps<{ title?: string; subtitle?: string }>) => {
  return (
...
export const WarnView = (props: ParentProps<{ title?: string; subtitle?: string }>) => {
  return (
...
export const EmptyView = (props: ParentProps<{ title?: string; subtitle?: string }>) => {
  return (
    <div class="text-center py-8 text-slate-600 flex flex-col items-center gap-4">
      <ImFileEmpty size={35} />
      <div>
